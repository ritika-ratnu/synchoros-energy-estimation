...
set hierarchy_files [split [read [open ${SOURCE_DIR}/router_hierarchy.txt r]] "\n"]
...
set hierarchy_files [split [read [open ${SOURCE_DIR}/hycube_hierarchy.txt r]] "\n"]
