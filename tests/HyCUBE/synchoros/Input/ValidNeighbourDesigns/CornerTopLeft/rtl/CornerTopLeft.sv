...
// Internal signals
//Start of the segment that needs to be hard coded---
...
//End of segment that needs to be hard coded.
wire [4:0] addr;
...
//Start of segment that needs to be hardcoded
...
//End of segment that needs to be hardcoded
`ifdef DEBUG_TRACE
//Debug statements
